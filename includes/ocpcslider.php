                            ...
                            echo '<div class="ocpcmain_image_class">';
                                echo '<div class="ocpc_image_class">';
                                    ...
                                    if (!empty($ocpc_postimgurl)) { 
                                        ...
                                        ?>
                                            <a href="<?php echo get_permalink($ocpc_attachment->ID); ?>" id="ocpc-postlink">
                                                <img src="<?php echo esc_url(OCPC_PLUGIN_DIR .'/images/placeholder.jpg');?>" class="ocpc-image" />
                                            </a>
                                        <?php 
                                    } 
                                echo '</div>';
                                    ...
                                    if($ocpc_postdescription == 'yes') { 
                                        ?>
                                            <div class="ocpc-content">
                                              <?php echo $this->OCPC_limited_content($postdesclength,$readmoretext,$datacontain);?>
                                            </div>
                                        <?php 
                                    } 
                                echo '</div>';
                                        ...
                                        if($post_layout == "masonry"){
                                            if (!empty($ocpc_postimgurl)) { 
                                             ...
                                             if (!empty($ocpc_postimgurl)) { ?>
                                               ...
                                               <?php } else { ?>
                                                <a href="<?php echo get_permalink(); ?>" id="ocpc-postlink"><img src="<?php echo esc_url(OCPC_PLUGIN_DIR .'/images/placeholder.jpg');?>" class="ocpc-image" /></a>
                                               <?php } 
                                            }
                            echo '</div>';
                        echo '</div>';
